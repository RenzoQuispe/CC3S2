...
- [Actividad 1: Introducción devops y devsecops ](./Actividad1-CC3S2/Actividad1-CC3S2.md)
- [Actividad 2: HTTP, DNS, TLS y 12-Factor (port binding, configuración, logs)](./Actividad2-CC3S2/REPORT.md)
- [Actividad 3: Integración de DevOps y DevSecOps con HTTP, DNS, TLS y 12-Factor App](./Actividad3-CC3S2/Respuestas.md)
- [Actividad 4: Introducción a herramientas CLI en entornos Unix-like para DevSecOps](./Actividad4-CC3S2/README.md)
- [Actividad 5: Construyendo un pipeline DevOps con Make y Bash](./Actividad5-CC3S2/Actividad5-CC3S2.md)
